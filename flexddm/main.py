...
def fit(models,  input_data, startingParticipants=None, endingParticipants=None, input_data_id="PPT", input_data_condition="Condition", input_data_rt="RT", input_data_accuracy="Correct", output_fileName='output.csv', return_dataframes=False, posterior_predictive_check=True):
    modelfit.fit(models, input_data, startingParticipants, endingParticipants, input_data_id, input_data_condition, input_data_rt, input_data_accuracy, output_fileName, return_dataframes, posterior_predictive_check)
...
class mRace_Emotion_Bias_DMC(Model):
    ...
    def __init__(self, data=None, input_data_id="PPT", input_data_congruency="Condition", 
        ...
        """
        self.modelsimulationfunction = mRace_Emotion_Bias_DMC.model_simulation
    ...
    def model_simulation(alpha, beta, characteristic_time, emotion_bias, 
